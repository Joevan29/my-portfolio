...
export const RevealLinks = () => {
    return (
        <section className="flex flex-col md:flex-row mt-5 gap-5 text-white w-fit">
            ...
            <FlipLink href="https://github.com/joevan29" hoverText="Coding" Icon={FaGithub}>
                Github
            </FlipLink>
            <FlipLink href="https://www.instagram.com/jvnpmrnachmd/" hoverText="Cats❤️" Icon={FaInstagram}>
                Instagram
            </FlipLink>
        </section>
    );
